...
[CreateAssetMenu]
public class FloatRangePerPowerLevel : Saveable<FloatRangePerPowerLevel>
{
    [SerializeField]
    ...
    public static FloatRangePerPowerLevel Create (string name, FloatRange minorRange, FloatRange mediumRange, FloatRange majorRange)
    {
        FloatRangePerPowerLevel newPerPowerLevelRange = CreateInstance<FloatRangePerPowerLevel>();
