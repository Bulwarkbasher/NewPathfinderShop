...
[CustomPropertyDrawer(typeof(FlagsEnumSetting))]
public class FlagsEnumSettingDrawer : JsonableDrawer
{
    ...
    protected override void OnJsonableGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        for (int i = 0; i < m_EnumSetting.Length; i++)
        {
            ...
            enumValueProp.boolValue = EditorGUI.ToggleLeft(position, elementLabel, enumValueProp.boolValue);
        }
